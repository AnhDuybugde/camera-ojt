...
class ConfigTest(TestCase):
    def test_load_config(self) -> None:
        ...
        self.assertEqual(config.face.match_threshold, 0.70)
        self.assertEqual(config.face.min_margin, 0.10)
        self.assertEqual(config.face.consensus_hits, 3)
        ...
        self.assertEqual(config.voice.backend, "imou_web")
